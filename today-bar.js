...
(function () {
  ...
  function render() {
    ...
    function box(lab, val, f, mw) { var c = caut(f); return '<span class="rtb-seg' + (c ? ' rtb-stale' : '') + '"' + (mw ? ' style="min-width:' + mw + 'px"' : '') + (c ? ' title="Not updating"' : '') + '><span class="rtb-lab">' + lab + (c ? ' ⚠️' : '') + '</span><b>' + val + '</b></span>'; }
