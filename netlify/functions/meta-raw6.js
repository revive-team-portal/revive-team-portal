...
const ACCT=process.env.META_AD_ACCOUNT||'act_242089740673955';const GUARD='95cb2a87f23fe5828e0b0aac82f13050';
exports.handler=async(e)=>{const q=(e&&e.queryStringParameters)||{};
 ...
 let url=GRAPH+'/'+p+'?'+String(q.q||'')+'&limit='+(q.limit||'100')+'&access_token='+encodeURIComponent(TOKEN);
